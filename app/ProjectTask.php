...
class ProjectTask extends Model implements HasMedia
{
    ...
    protected $fillable = ['name', 'description', 'priority', 'startdate', 'duedate', 'datefinished', 'status', 'recurring_type', 'recurring_value', 'cycles', 'total_cycles', 'last_recurring_date', 'is_public', 'billable', 'billed', 'hourly_rate', 'milestone', 'kanban_order', 'milestone_order', 'visible_to_client', 'deadline_notified', 'recurring_id', 'project_id', 'mile_stone_id', 'created_by_id','company_id'];
    protected $hidden = [];
