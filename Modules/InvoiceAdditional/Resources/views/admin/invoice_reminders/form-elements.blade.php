<div class="row">
    ...
    <div class="form-group">
        {!! Form::label('date', trans('global.invoice-reminders.fields.date').'*', ['class' => 'control-label']) !!}
    ...
    <?php
    $isnotified = 'no';
    if ( ! empty( $invoice_reminder ) ) {
        $isnotified = $invoice_reminder->isnotified;
    }
    ?>
    ...
    <div class="col-xs-4">
    <div class="form-group">
        {!! Form::label('reminder_to_id', trans('global.invoice-reminders.fields.reminder-to').'*', ['class' => 'control-label']) !!}
    ...
    <div class="col-xs-4">
    <div class="form-group">
        {!! Form::label('notify_by_email', trans('global.invoice-reminders.fields.notify-by-email').'', ['class' => 'control-label']) !!}
...
<div class="row">
    <div class="col-xs-6">
    <div class=" form-group">
        {!! Form::label('description', trans('global.invoice-reminders.fields.description').'*', ['class' => 'control-label']) !!}
