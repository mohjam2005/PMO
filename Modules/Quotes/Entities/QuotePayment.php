...
class QuotePayment extends Model
{
    ...
    protected $table = 'quotes_payments';

    protected $fillable = ['date', 'amount', 'transaction_id', 'quote_id', 'account_id', 'paymentmethod', 'description'];
    protected $hidden = [];
    ...
    public static function boot()
    {
        ...
        QuotePayment::observe(new \App\Observers\UserActionsObserver);
    }
    ...
    {
        return $this->belongsTo(Quote::class, 'invoice_id')->withTrashed();
    }
