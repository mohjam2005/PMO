...
class UpdateQuotesRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        $rules['invoice_no'] = 'required|numeric|unique:quotes,invoice_no,' . $this->route('quote');        
        return $rules;
    }
    public function messages() {
        $messages = [
            'invoice_no.required' => trans('custom.quotes.invoice-no-required'),
            'invoice_no.numeric' => trans('custom.quotes.invoice-no-numeric'),
            'invoice_no.unique' => trans('custom.quotes.invoice-no-unique'),
        ];
