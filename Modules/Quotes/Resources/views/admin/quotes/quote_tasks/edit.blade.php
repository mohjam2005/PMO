...
@section('content')
    ...
    {!! Form::model($quote_task, ['method' => 'PUT', 'route' => ['admin.quote_tasks.update', $quote_task->quote_id, $quote_task->id],'class'=>'formvalidation']) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
             @include('quotes::admin.quotes.quote_tasks.form-fields', compact('quote_task'))            
        </div>
    </div>
