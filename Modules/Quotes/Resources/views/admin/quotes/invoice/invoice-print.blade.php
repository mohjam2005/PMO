...
<a href="{{route('admin.quotes.show', $invoice->id)}}" class="btn btn-info" role="button">@lang('custom.invoices.back-to-quotes')</a>
...
<style>
   ...
   .wrapper{
    ...
    {{ getSetting('quote-footer', 'quote-settings') }}</p>
    </div>  
    @endif
