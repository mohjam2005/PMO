...
@section('content')
    ...
    {!! Form::model($proposal_task, ['method' => 'PUT', 'route' => ['admin.proposal_tasks.update', $proposal_task->proposal_id, $proposal_task->id],'class'=>'formvalidation']) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
             @include('proposals::admin.proposals.proposal_tasks.form-fields', compact('proposal_task'))            
        </div>
    </div>
        ...
        $(function () {
            $('.file-upload').each(function () {
                ...
                $(this).fileupload({
                    dataType: 'json',
                    formData: {
                        model_name: 'Modules\\Quotes\\Entities\\QuoteTask',
