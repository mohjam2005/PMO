...
class ProposalPayment extends Model
{
    ...
    protected $table = 'proposals_payments';

    protected $fillable = ['date', 'amount', 'transaction_id', 'proposal_id', 'account_id', 'paymentmethod', 'description'];
    protected $hidden = [];
    ...
    public static function boot()
    {
        ...
        ProposalPayment::observe(new \App\Observers\UserActionsObserver);
    }
    ...
    {
        return $this->belongsTo(Proposal::class, 'invoice_id')->withTrashed();
    }
