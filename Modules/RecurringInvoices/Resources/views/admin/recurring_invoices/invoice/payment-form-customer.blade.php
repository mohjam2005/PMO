...
<div class="modal-header">
	...
	<h3>{{trans('custom.invoices.recurring_invoice_no') . $invoice->invoicenumberdisplay }} ({{digiCurrency( $amount_due , $invoice->currency_id )}})</h3>
</div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
      <input type="text" class="form-control datepicker" value="{{digiTodayDate()}}" name="date" id="date" disabled>
    </div>
  </div>
...
<div class="form-group">
    ...
    <div class="col-sm-9">
      <textarea id="description" name="description" class="form-control" disabled>{{trans('custom.invoices.payment-for') . ' #' . $invoice->invoice_no}}</textarea>
    </div>
  </div>
