    ...
    .main-header .navbar .nav > li > a > .label{
        ...
        <article>
            <table class="balance">
                ...
                @if( ! empty( $invoice->invoice_due_date ) )
                <tr>
            ...
            ?>
             ...
             <article>
                <table class="beta4">
                     ...
                     <tr><td><code>{!!$invoice->invoice_notes!!} </code></td></tr>
                     @endif
