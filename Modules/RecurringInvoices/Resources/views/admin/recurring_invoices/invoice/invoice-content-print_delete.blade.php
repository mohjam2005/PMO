...
<p style="font-size: 13px; float: right; font-weight: 700; margin-top: -160px; margin-right: -20px;">{{getSetting('site_address', 'site_settings')}}</p></span>
		...
		<article>
			...
			<table class="balance" style="/*! margin-right: 90px; */;">
                ...
                <?php } ?>
                <tr>
                    <th><span>{{trans('recurringinvoices::custom.invoices.repeat-on')}}</span></th>
                    <td><span>{{$invoice->recurring_period->title }}</span></td>
                </tr>
				<tr>
 ...
 <div class="column" >
    <header >
			<address solox style="width: 300px;">
				<p>{{trans('recurringinvoices::custom.invoices.repeat-on')}}<b>{{$invoice->recurring_period->title }}</b></p>
    ...
    <header>
			<address>
				...
				<span style="float: right;
                                                    ...
                                                    padding-right: 33px;
                                                    margin-left: 184px;
                                                    margin-right: -42px;">({{$authorized_person}})</span>
				@endif
				@if( ! empty( $authorized_designation ) )
				<br><span style="float:right; /*! padding-top: 40px; *//*! matgin-right: 0px; */">{{$authorized_designation}}</span>
				@endif
			</address>
		</header>
</div>
