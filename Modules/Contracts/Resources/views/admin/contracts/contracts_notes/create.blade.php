...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.contracts_notes.store', $contract->id]]) !!}
        ...
        <div class="panel-body">
            <div class="row">
                ...
                <div class="form-group">
                    {!! Form::label('description', trans('global.contracts-notes.fields.description').'*', ['class' => 'control-label']) !!}
