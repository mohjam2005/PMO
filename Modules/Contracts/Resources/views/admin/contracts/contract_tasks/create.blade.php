...
@section('content')
    ...
    {!! Form::open(['method' => 'POST', 'route' => ['admin.contract_tasks.store', $contract->id],'class'=>'formvalidation']) !!}
    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            @include('contracts::admin.contracts.contract_tasks.form-fields')
        </div>
    </div>
        ...
        $(function () {
            $('.file-upload').each(function () {
                ...
                $(this).fileupload({
                    dataType: 'json',
                    formData: {
                        model_name: 'Modules\\Contracts\\Entities\\ContractTask',
