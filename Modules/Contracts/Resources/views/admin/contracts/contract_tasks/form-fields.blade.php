...
<div class="col-xs-{{COLUMNS}}">
    ...
    {!! Form::label('name', trans('global.contract-tasks.fields.name').'*', ['class' => 'control-label']) !!}
...
<?php
$priorities = \Modules\DynamicOptions\Entities\DynamicOption::where('module', '=', 'contracts')->where('type', '=', 'priorities')->get()->pluck('title', 'id')->prepend(trans('global.app_please_select'), '');
?>
<div class="col-xs-{{COLUMNS}}">
<div class="form-group">
    {!! Form::label('priority_id', trans('global.contract-tasks.fields.priority').'*', ['class' => 'control-label']) !!}
...
<div class="col-xs-{{COLUMNS}}">
<div class="form-group">
    {!! Form::label('startdate', trans('global.contract-tasks.fields.startdate').'*', ['class' => 'control-label']) !!}
      <?php
        $startdate = digiTodayDateAdd();
        if ( ! empty( $contract_task ) ) {
            $startdate = ! empty( $contract_task->startdate ) ? digiDate( $contract_task->startdate ) : '';
        }
        ?>
...
<div class="col-xs-{{COLUMNS}}">
<div class="form-group">
    {!! Form::label('duedate', trans('global.contract-tasks.fields.duedate').'', ['class' => 'control-label']) !!}
     <?php
...
<div class="col-xs-{{COLUMNS}}">
<div class="form-group">
    {!! Form::label('status_id', trans('global.contract-tasks.fields.status').'', ['class' => 'control-label']) !!}
    <?php
    $statuses = \Modules\DynamicOptions\Entities\DynamicOption::where('module', '=', 'contracts')->where('type', '=', 'taskstatus')->get()->pluck('title', 'id')->prepend(trans('global.app_please_select'), '');
    ?>
...
<!-- <div class="col-xs-{{COLUMNS}}">
<div class="form-group">
    {!! Form::label('is_public', trans('global.contract-tasks.fields.is-public').'', ['class' => 'control-label']) !!}
...
<div class="col-xs-{{COLUMNS}}">
<div class="form-group">
    {!! Form::label('billable', trans('global.contract-tasks.fields.billable').'', ['class' => 'control-label']) !!}
...
<div class="col-xs-{{COLUMNS}}">
<div class="form-group">
    {!! Form::label('recurring_id', trans('global.contract-tasks.fields.recurring').'', ['class' => 'control-label']) !!}
...
<div class="col-xs-{{COLUMNS}}">
<div class="form-group">
    {!! Form::label('recurring_type', trans('global.contract-tasks.fields.recurring-type').'', ['class' => 'control-label']) !!}
...
<div class="col-xs-{{COLUMNS}}">
<div class="form-group">
    {!! Form::label('recurring_value', trans('global.contract-tasks.fields.recurring-value').'', ['class' => 'control-label']) !!}{!!digi_get_help(trans('global.recurring-invoices.recurring-value-help'), 'fa fa-question-circle')!!}
    <?php
    $recurring_value = 0;
    if ( ! empty( $contract_task ) ) {
        $recurring_value = $contract_task->recurring_value;
    }
    ?>
...
<div class="col-xs-{{COLUMNS}}">
<div class="form-group">
    {!! Form::label('cycles', trans('global.contract-tasks.fields.cycles').'', ['class' => 'control-label','min'=>'0','step'=>'.01']) !!}{!!digi_get_help(trans('global.recurring-invoices.total-cycles-help'), 'fa fa-question-circle')!!}
    <?php
    $cycles = 0;
    if ( ! empty( $contract_task ) ) {
        $cycles = $contract_task->cycles;
    }
    ?>
...
<div class="col-xs-{{COLUMNS}}">
<div class="form-group">
    {!! Form::label('visible_to_client', trans('global.contract-tasks.fields.visible-to-client').'', ['class' => 'control-label']) !!}
...
<div class="col-xs-{{COLUMNS}}">
    <div class="form-group">
        {!! Form::label('attachments', trans('global.contract-tasks.fields.attachments').'', ['class' => 'control-label']) !!}
        ...
        <div class="photo-block">
            ...
            <div class="files-list">
                @if ( ! empty( $contract_task ) )
                @foreach($contract_task->getMedia('attachments') as $media)
                    <p class="form-group">
    ...
    <div class="row">
     ...
     <div class="col-xs-12">
    <div class="form-group">
    {!! Form::label('description', trans('global.contract-tasks.fields.description').'', ['class' => 'control-label']) !!}
