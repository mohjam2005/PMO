<div class="modal-header">
	...
	<h3>{{trans('contracts::custom.contracts.contract_no') . $invoice->invoicenumberdisplay}}</h3>
</div>
		...
		<div class="col-sm-10">
			<div class="checkbox c-checkbox">
				<label>
					...
					?>
					<a href="{{ asset(env('UPLOAD_PATH').'/uploads/contracts/' . $filename ) }}" target="_blank">{{$filename}}</a>
				</label>
			</div>
		</div>
	</div>
