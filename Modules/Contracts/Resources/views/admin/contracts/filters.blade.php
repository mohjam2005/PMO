        ...
        <div class="col-md-12">
            ...
            <div class="form-group filter-group">
                ...
                $date_types = array(
                    ...
                    'invoice_date' => trans('global.invoices.fields.contract-date'),
                    'invoice_due_date' => trans('global.invoices.fields.contract-expiry-date'),
                );
                ?>
            ...
            <div class="form-group filter-group">
                ...
                $paymentstatuses = array(
                    ...
                    'delivered' => trans('others.statistics.total-delivered'),
                    'rejected' => trans('others.statistics.total-rejected'),
                    'accepted' => trans('others.statistics.total-accepted'),
