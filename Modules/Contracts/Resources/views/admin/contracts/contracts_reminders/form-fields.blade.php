<div class="row">
    ...
    <div class="col-xs-4">
        {!! Form::label('date', trans('global.contracts-reminders.fields.date').'*', ['class' => 'control-label']) !!}
        ...
        <?php
    $isnotified = 'no';
    if ( ! empty( $contracts_reminder ) ) {
        $isnotified = $contracts_reminder->isnotified;
    }
    ?>
    ...
    <div class="form-group">
    <div class="col-xs-4">
        {!! Form::label('reminder_to_id', trans('global.contracts-reminders.fields.reminder-to').'*', ['class' => 'control-label']) !!}
    ...
    <div class="form-group">
    <div class="col-xs-4">
        {!! Form::label('notify_by_email', trans('global.contracts-reminders.fields.notify-by-email').'', ['class' => 'control-label']) !!}
 ...
 <div class="row">
    <div class="form-group">
    <div class="col-xs-6">
        {!! Form::label('description', trans('global.contracts-reminders.fields.description').'*', ['class' => 'control-label']) !!}
