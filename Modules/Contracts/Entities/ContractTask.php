...
class ContractTask extends Model implements HasMedia
{
    ...
    public static function boot()
    {
        ...
        ContractTask::observe(new \App\Observers\UserActionsObserver);
    }
    ...
    {
        return $this->belongsTo(\Modules\Contracts\Entities\Contract::class, 'contract_id')->withTrashed();
    }
    ...
    {
        return $this->belongsToMany(\App\User::class, 'quote_task_user');
    }
