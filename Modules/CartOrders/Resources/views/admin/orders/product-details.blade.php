...
<div class="col-lg-8">
    ...
    <div class="form-group">
        <input type="number" class="form-control" id="item_quantity" name="item_quantity" placeholder="@lang('orders::global.orders.quantity')" min="1" max="{{$product->stock_quantity}}" value="1">
